...
rainfall = read_weather("RAINFALL2022.csv", "Rainfall amount (millimetres)")
maxtemp = read_weather("MAXTEMP2022.csv", "Maximum temperature (Degree C)")
mintemp = read_weather("MINTEMP2022.csv", "Minimum temperature (Degree C)")
merged_data = merge_data(rainfall, maxtemp, mintemp)
write_csv("weather.csv", merged_data)
