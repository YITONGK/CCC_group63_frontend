...
accidents_filtered = read_accidents('../data/ACCIDENT.csv', datetime(2022, 1, 1), datetime(2023, 9, 30))
road_surface_data = read_road_surface('../data/ROAD_SURFACE_COND.csv')
merged_results = merge_data(accidents_filtered, road_surface_data)
write_csv('../data/accident_road_surface.csv', merged_results)

csv_file_path = '../data/accident_road_surface.csv'
df = pd.read_csv(csv_file_path)

json_file_path = '../data/accident_road_surface.json'
